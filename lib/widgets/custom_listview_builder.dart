...
class CustomListviewBuilder extends StatefulWidget {
  ...
  const CustomListviewBuilder({super.key, required this.itemBuilder, required this.itemCount, required this.scrollDirection, this.scrollable, this.reverse});
}
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        physics: (widget.scrollable != null && widget.scrollable == false) ? const NeverScrollableScrollPhysics() : const BouncingScrollPhysics(),
