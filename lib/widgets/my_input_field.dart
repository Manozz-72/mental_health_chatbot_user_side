    ...
    return Container(
      ...
      child: TextFormField(
          ...
          return Visibility(
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: Text(
                  currentLength.toString() + (widget.limit != null ? "/$maxLength" : ""),
        ...
        decoration: InputDecoration(
            ...
            labelStyle: TextStyle(color: const Color(0xFF000000),fontSize: 13.sp,),
            ...
            hintStyle: TextStyle(color: const Color(0xff1b1b1b),fontSize: 13.sp),
